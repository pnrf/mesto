...
**22.03.2022** - устраняю замечания код-ревьюера (4 критических + 4 рекомендации)
...
**23.03.2022** - устраняю замечания код-ревьюера (1 критическое + рекомендация по его устранению)
...
**09.04.2022** - приступил к выполнению практической работы по 7-му спринту.
...
**24.04.2022** - приступил к изучению Webpack (8 спринт) и выполнению ПР 8
